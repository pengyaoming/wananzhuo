...
public class DialogUtil extends AlertDialog {
    ...
    protected DialogUtil(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
     ...
     * @return DialogUtil
     */
    public static DialogUtil create(Context context, String title, String message, String confirm, View.OnClickListener
        ...
        DialogUtil dialog = new DialogUtil(context, cancelable, canceledOnTouchOutside);
     ...
     * @return DialogUtil
     */
    public static DialogUtil create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
